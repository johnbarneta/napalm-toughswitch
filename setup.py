...
setup(
    name="napalm-toughswitch",
    version="0.0.2",
    packages=find_packages(),
    author="Juan Gomez",
    author_email="jgomez@phicus.es",
    description="Network Automation and Programmability Abstraction Layer driver for Ubiquti Toughswitch using SSH",
    ...
    url="https://github.com/johnbarneta/napalm-toughswitch",
